...
export interface XPNftHts extends BaseContract {
  ...
  functions: {
    ...
    initialize(
      ...
      claimContract_: PromiseOrValue<string>,
      numerator: PromiseOrValue<BigNumberish>,
      denominator: PromiseOrValue<BigNumberish>,
      feeCollector: PromiseOrValue<string>,
      amountForFixed: PromiseOrValue<BigNumberish>,
      feeCollectorFixed: PromiseOrValue<string>,
    ...
    safeTransferFrom(
      ...
      _serialNum: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
